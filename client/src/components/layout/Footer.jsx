      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2">
            ...
            <p className="text-text-secondary mb-6 max-w-xs">
              Animate Without Limits. Create stunning animations directly in your browser.
            </p>
            <div className="flex items-center gap-4">
              {/* Social Icons */}
              <a href="#" className="p-2 rounded-lg bg-background-tertiary text-text-secondary hover:text-accent-cyan transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-text-muted text-sm">
            © {currentYear} MotionForge. All rights reserved.
          </p>
          <p className="text-text-muted text-sm">
            Powered by <span className="text-accent-cyan font-semibold">Ahmedmediaworkx</span>
          </p>
        </div>
      </div>
    </footer>
